...
import Collect.EmployeeRoll;
import java.util.ArrayList;
import java.util.Iterator;
import java.util.Scanner;

public class EmployeeRollMain
{
static Scanner sc=new Scanner(System.in);
   public static void main(String[] args)
    {
        ArrayList<EmployeeRoll> ar=new ArrayList<> ();
        menu( ar);
    }
  static void menu( ArrayList<EmployeeRoll> ar)
        ...
        if(choice==1)
            {
              ...
              EmployeeRoll ep = new EmployeeRoll(name,emp_id,sal);
                ar.add(ep);
